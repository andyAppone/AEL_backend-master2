 ...
 */
class AelLiftPm extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['lift_id','pm_schedule_end_datetime','pm_schedule_start_datetime','pm_service_checklist', 'pm_status', 'client_id', 'worker_1_id', 'worker_2_id', 'supervisor_id'], 'required'],
            //[['id', 'lift_id', 'client_id', 'worker_1_id', 'worker_2_id', 'supervisor_id'], 'integer'],
            [['created_datetime', 'updated_datetime', 'pm_schedule _start_datetime', 'pm_schedule _end_datetime', 'pm_actual_start_datetime', 'pm_actual_end_datetime'], 'safe'],
            [['is_active', 'is_deleted', 'pm_status', 'is_canceled'], 'string'],
            [['pm_qr_code', 'lift_name', 'lift_name_chi'], 'string', 'max' => 50],
        ];
    }
