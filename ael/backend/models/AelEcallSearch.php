 ...
 */
class AelEcallSearch extends AelLiftPm
{
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query = (new \yii\db\Query())
                ->select("alp.id,alp.ecall_launch_datetime,alp.updated_datetime,alp.ecall_qr_code,al.lift_name,au.first_name as client,au1.first_name as supervisor,au2.first_name as worker,au3.first_name as enginner,asc.lift_checklist_details")
                ->from('ael_lift_ecall as alp')
                ...
                ->join('LEFT JOIN','ael_service_checklist AS asc','asc.id = alp.ecall_service_checklist');     
