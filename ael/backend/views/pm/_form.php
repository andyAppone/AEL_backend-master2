...
<div class="ael-lift-pm-form">
    ...
    <div class="form-group">
        ...
        <img src="<?php echo '../assets/qrcode/'.$model->pm_qr_code.'.png'; ?>">
    </div>    
    <?php } ?>
    
    <?php echo $form->field($model, 'pm_schedule_start_datetime')->widget(DateTimePicker::className(), [
        'language' => 'en',
        'size' => 'ms',
        'template' => '{input}',
    ...
    <?php echo $form->field($model, 'pm_schedule_end_datetime')->widget(DateTimePicker::className(), [
        'language' => 'en',
        'size' => 'ms',
        'template' => '{input}',
        'pickButtonIcon' => 'glyphicon glyphicon-time',
    ...
    <?php echo $form->field($model, 'pm_service_checklist')->widget(Select2::classname(), [
        'data' => $checklistData,
        'language' => 'en',
    ...
    <?= $form->field($model, 'pm_status')->dropDownList([ '1' => 'Scheduled,','2' => 'Completed successfully','3'=>'Work in progress','4'=>'Need follow up' ], ['prompt' => '--Select Status--']); ?>
    <div class="form-group">
