...
<?php Pjax::begin(); ?>    <?= GridView::widget([
        ...
        'columns' => [
            ...
            'enginner',
            [
                'attribute' => 'pm_schedule_start_datetime',
                'format'    => 'raw',
                'label'     => 'Schedule Start',
                'value'     => function ($model) {
                    if($model['pm_schedule_start_datetime'] != '') {
                        return date("d F Y",strtotime($model['pm_schedule_start_datetime']));
                    }
                },
            ],
            [
            ...
            [
                    ...
                    'buttons' => [
                        ...
                        'view' => function ($url, $model) {
                            ...
                            $url = yii\helpers\Url::to(['pm/changestatus', 'id' => $model['id'],'status'=>$statusValue]);
