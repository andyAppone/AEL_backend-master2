        ...
        'columns' => [
            ...
            /*[
                ...
                'value'     => function ($model) {
                    ...
                    $userTypeData =  $modelUserType->find()->where(['id'=>$model->user_type])->asArray()->all();
                    if(!empty($userTypeData)) {
                        return $userTypeData[0]['user_type'];
                    }
                },
                'filter' => false,
            ],*/
            [
                    ...
                    'buttons' => [
                        ...
                        'view' => function ($url, $model) {
                            ...
                            $url = yii\helpers\Url::to(['user/changestatus', 'id' => $model->id,'status'=>$statusValue]);
